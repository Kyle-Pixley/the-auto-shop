...
function RepairServices({ isDesktop }) {
  return (
    <div id='repair-services-container'>
        ...
        <div id='repair-types-parent'>
            <h1 style={{color: 'black', textAlign: 'center', width: '92vw'}}>Our technicians are certified to repair:</h1>
            <div style={{height:'6px',width:'35vw',backgroundColor: 'rgb(240,128,128)',marginTop: '18px', borderRadius: '50%'}}></div>
